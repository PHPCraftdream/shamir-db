...
//!
//! Implements `docs/client-server-protocol-spec/AUTH_PROTOCOL.md` v1: transport-agnostic SCRAM-Argon2id
...
//! `docs/client-server-protocol-spec/AUTH_PROTOCOL.md` §1-§19. Wire-level test vectors live in
