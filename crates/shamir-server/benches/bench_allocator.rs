...
//   cargo bench -p shamir-server --features bench-sefer-tuned    # sefer + production LargeCacheConfig
//   cargo bench -p shamir-server --features bench-mimalloc       # mimalloc
//   cargo bench -p shamir-server                                 # system default
