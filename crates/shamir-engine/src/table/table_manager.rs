...
pub struct TableManager {
    ...
    validator_bindings: Arc<arc_swap::ArcSwap<Vec<crate::validator::ValidatorBinding>>>,
...
impl TableManager {
    ...
    // ---- Per-table validator bindings (S2 DDL surface) ----
    ...
    // ---- S3: validator registry injection + write-path pass ----
