...
pub use shamir_query_types::admin::{
    ...
    DropTableOp, FieldRuleDto, GetBufferConfigOp, GetTableSchemaOp, GroupRef, ListOp, NumDto,
    PurgeScope, RemoveGroupMemberOp, RemoveSchemaRuleOp, ResourceRef, SetBufferConfigOp,
    SetTableSchemaOp,
};
