...
| `codecs/interned/json.rs` | 35 | JSON-кодек (v1-inbound `QueryRecord::Json` + control-plane) |
...
| **Filter/index адаптеры** | `resolve.rs` (`filter_value_to_inner` ← read_planner index-bound; `resolve_filter_value` ← JSON-twin) | документировано E5/E6 |
