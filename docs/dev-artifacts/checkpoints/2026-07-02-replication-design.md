...
`docs/dev-artifacts/roadmap/PLAN.md`). Итог — четыре коммита за сессию, ноль
in-flight, две активные pending-таски (#365, #366).

**Основной результат — два дизайн-документа + один pre-refactor-план:**

- `docs/dev-artifacts/roadmap/REPLICATION.md` (~595 строк) — тот самый док, который
...
- `docs/dev-artifacts/research/REPLICATION-PRE-REFACTOR-2026-06-30.md` (~199 строк) —
...
**Inspected в этой сессии:** `docs/dev-artifacts/roadmap/PLAN.md`, `crates/shamir-tx/
