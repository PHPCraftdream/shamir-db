...
дизайну в `docs/dev-artifacts/design/declarative-schema-validators/`. Сделано и закоммичено: **Phase 0**
...
?? docs/dev-artifacts/checkpoints/  (this + 2026-06-23-declarative-schema-design.md)
```
