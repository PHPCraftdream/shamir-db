...
`docs/dev-artifacts/audits/2026-07-06-*.md`. This checkpoint picks up from
...
- **#524** (fjall worker-loop batching prototype) — **the most
  ...
  `docs/dev-artifacts/design/fjall-worker-loop-524-findings.md` (commit `e21e3c48`),
...
(`docs/dev-artifacts/prompts/audit/54-perf-532-mvccstore-rekey-recordkey.md`,
