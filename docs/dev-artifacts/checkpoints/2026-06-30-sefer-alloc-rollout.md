...
640 байт. Запротоколировали в `docs/dev-artifacts/perf/sefer-alloc-0.2.0-oom-bug-2026-06-30.md`.
...
- **Обновить устаревший perf-каваэт?** В `crates/shamir-server/Cargo.toml`
  и `docs/dev-artifacts/perf/sefer-alloc-rollout-2026-06-30.md` фигурирует фраза
