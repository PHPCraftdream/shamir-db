...
committed-бриф до запуска (prompt-first, `docs/dev-artifacts/prompts/replication/00..23`),
...
бриф `docs/dev-artifacts/prompts/replication/23-388-two-server-convergence.md` УЖЕ
...
`crates/shamir-client-node/src/lib.rs`. Дизайн — `docs/dev-artifacts/roadmap/
