...
`docs/dev-artifacts/research/NUMA-DESIGN-2026-06-29.md` (~330 строк) с фундаментом —
...
?? docs/dev-artifacts/checkpoints/2026-06-29-perf-campaign-2-close.md
?? docs/dev-artifacts/research/NUMA-DESIGN-2026-06-29.md
```
