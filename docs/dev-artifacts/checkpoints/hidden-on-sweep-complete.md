...
- **Dangling doc.** `docs/dev-artifacts/checkpoints/2026-06-22-0145.md` (post-Op#2
...
```
?? docs/dev-artifacts/checkpoints/2026-06-22-0145.md
?? docs/dev-artifacts/checkpoints/hidden-on-sweep-complete.md
```
