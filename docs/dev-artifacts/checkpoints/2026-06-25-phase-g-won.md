...
## Repo state
```
 M docs/dev-artifacts/research/ACTION-ITEMS.md
 M docs/dev-artifacts/research/DONE.md
 M docs/dev-artifacts/research/PHASE-G-PLAN.md
?? docs/dev-artifacts/checkpoints/2026-06-25-phase-g-planned.md  (+ этот файл)
