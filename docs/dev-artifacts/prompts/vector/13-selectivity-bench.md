...
> Реализуешь лист 3.3 плана `docs/dev-artifacts/roadmap/VECTOR_PRODUCTION_EXECUTION.md`
...
3. **Отчёт** `docs/dev-artifacts/benchmarks/vector/2026-07-05-filtered-ann.md`: таблица
   ...
   Обнови `docs/dev-artifacts/benchmarks/vector/README.md` (одна строка про новый отчёт).
