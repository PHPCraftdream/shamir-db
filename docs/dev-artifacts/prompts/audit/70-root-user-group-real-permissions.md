...
`docs/dev-artifacts/design/root-user-group-dac-posture-550-decision.md` §1 (already
...
canonical-store decision in `docs/dev-artifacts/design/identity-privilege-unification-548-549-decision.md`
