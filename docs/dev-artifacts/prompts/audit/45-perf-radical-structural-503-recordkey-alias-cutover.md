...
`docs/dev-artifacts/design/record-key-128-migration-plan.md` (task #491, audit finding
...
`docs/dev-artifacts/design/record-key-128-migration-plan.md` §3 and §4 item 2 describe
