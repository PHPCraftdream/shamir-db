...
`docs/dev-artifacts/roadmap/ACCESS_HIERARCHY.md:73-74`'s documented per-function
capability model.
...
3. **Design question to resolve before committing**: what does an EMPTY
   ...
   `docs/dev-artifacts/roadmap/ACCESS_HIERARCHY.md:73-74` and the audit doc's finding
