...
`docs/guide-docs/security/data-protection.md` documenting the at-rest encryption
model and the PII retention/erasure procedure (audit finding C6,
`docs/dev-artifacts/audits/2026-07-06-security-compliance-supplychain.md`). This is
...
Create `docs/guide-docs/security/data-protection.md` (check if a `docs/guide-docs/security/`
...
- The full content of `docs/guide-docs/security/data-protection.md` (or a summary
