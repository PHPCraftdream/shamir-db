...
> Контекст: `docs/dev-artifacts/research/REPLICATION-PRE-REFACTOR-2026-06-30.md` §Б PR4,
> `docs/dev-artifacts/roadmap/REPLICATION.md` §4.3. Зависит от PR1 (`BatchOp::is_write()`
