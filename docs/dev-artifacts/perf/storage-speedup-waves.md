...
Производный план из `docs/dev-artifacts/perf/storage-speedup-research-2026-06-19.md` (15 рычагов
L1–L15) и `docs/dev-artifacts/perf/bench-snapshot-2026-06-18.md` (база замеров). Каждый **этап**
