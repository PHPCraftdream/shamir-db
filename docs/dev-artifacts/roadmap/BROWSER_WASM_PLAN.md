...
- docs/guide-docs/client-server-protocol-spec/AUTH_PROTOCOL.md §3.7 — KDF parameters
- docs/guide-docs/client-server-protocol-spec/TRANSPORT_WS.md — WebSocket binding (browser endpoint)
- docs/guide-docs/client-server-protocol-spec/CLIENT_BROWSER.md — browser-specific guidance (memory-only ticket
  storage, etc.)
