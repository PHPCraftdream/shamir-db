...
> `docs/dev-artifacts/prompts/ddl-lifecycle/` под git ДО старта делегированных стадий.
...
- **Prompt-first**: бриф в `docs/dev-artifacts/prompts/ddl-lifecycle/` под git до старта;
