...
> `docs/dev-artifacts/research/` после кампаний ①/② (и Phase D/E/G). Реализация — делегирование
...
- Стратегия: prompt-first (бриф в `docs/dev-artifacts/prompts/campaign-3/` ДО агента, запрет
