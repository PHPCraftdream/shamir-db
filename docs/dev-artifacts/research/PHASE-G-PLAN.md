...
> `docs/dev-artifacts/prompts/<area>/` под git ДО старта делегированных стадий. Вся работа —
...
- Док-трек: `docs/dev-artifacts/roadmap/DDL.md` §0/§3, `docs/dev-artifacts/prompts/.../05-permissions.md §2`.
