...
· `docs/dev-artifacts/roadmap/ROADMAP.md`, `docs/dev-artifacts/roadmap/PLAN.md` (§3 "Resolved forks").

**Guiding principle (from `docs/dev-artifacts/roadmap/PLAN.md` §3 and
`docs/dev-artifacts/roadmap/ROADMAP.md`):** OQL is **object-native by design, forever — no
...
- Index kinds (per `docs/dev-artifacts/roadmap/PLAN.md` §1 + index README): hash (regular +
...
- **Evidence:** no graph traversal primitive in `Filter`/`SelectItem`. The
  roadmap (`docs/dev-artifacts/roadmap/PLAN.md` §0.2, §2) names the "I" frontier as
...
- **Evidence:** `Filter::Fts` (AND/OR token modes) is index-accelerated
  ...
  **no highlight/fragment return**. Docs (`docs/dev-artifacts/roadmap/FULL_TEXT_SEARCH.md`)
...
- **OQL is a deliberately object-native language** (`docs/dev-artifacts/roadmap/PLAN.md` §3):
...
- **Roadmap alignment:** none of H1–H5 appear on the read roadmap
  (`docs/dev-artifacts/roadmap/`); the live frontier is Movement C (replication / "I"),
