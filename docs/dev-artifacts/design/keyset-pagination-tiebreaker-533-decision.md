...
Scoped out of G2/#526 (`docs/dev-artifacts/prompts/audit/47-perf-g2-526-keyset-short-page-fix.md`).
...
compromise `docs/dev-artifacts/design/keybytes-inline-cap-506-decision.md` and other
