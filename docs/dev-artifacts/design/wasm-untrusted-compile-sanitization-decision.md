...
`docs/dev-artifacts/audits/2026-07-06-security-network-surface.md` (Топ-5 #2), partially
closed by CRIT-6/#440 (`docs/dev-artifacts/prompts/audit/06-wasm-host-untrusted-compile-and-definer-security.md`),
re-confirmed as **CRITICAL (остаточная)** in
`docs/dev-artifacts/audits/2026-07-10-security-permission-wasm-functions.md` (находка #1)
and rolled up in `docs/dev-artifacts/audits/2026-07-10-security-permission-SUMMARY.md`.
