...
**Plus:** docs/guide-docs/client-server-protocol-spec/diagram fixes for the §8.5 latency-padding wiring and one
...
## Round 2 (added after second perf review + docs/guide-docs/client-server-protocol-spec/diagram audit)
...
`docs/guide-docs/client-server-protocol-spec/AUTH_PROTOCOL.md`
