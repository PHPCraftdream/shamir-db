...
`docs/dev-artifacts/ops/PERF_OPTIMIZATIONS.md` (full bench numbers).
...
- `docs/dev-artifacts/ops/PERF_OPTIMIZATIONS.md` — full bench numbers для R0
  (shamir-connect + transport-tcp).
- `docs/dev-artifacts/ops/PERF_BASELINE.md` — raw baseline numbers до начала
  оптимизаций.
- `docs/dev-artifacts/ops/PERF-PLAN.md`, `docs/dev-artifacts/ops/PERF-PLAN-NEXT.md` — planning
  docs для R1 / R3.
- `docs/dev-artifacts/roadmap/PERF_OPPORTUNITIES.md` — найденные opportunity в R1.
