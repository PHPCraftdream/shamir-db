...
**Фикс.** Завести `docs/guide-docs/security/data-protection.md`: явно зафиксировать модель at-rest
...
6. **LOW-MED C6** — `docs/guide-docs/security/data-protection.md` (at-rest, PII-erasure/retention).
