...
`docs/design/identity-privilege-unification-548-549-decision.md` §7
...
the `docs/client-server-protocol-spec/` documentation.
...
### §4. Update `docs/client-server-protocol-spec/`

Grep `docs/client-server-protocol-spec/` (including `diagrams/`) for
...
`docs/research/coverage-ts-query-builder.md` also has stale coverage
...
- `docs/client-server-protocol-spec/` and
  `docs/research/coverage-ts-query-builder.md` no longer reference the
