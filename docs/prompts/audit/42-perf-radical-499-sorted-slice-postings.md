...
`docs/audits/2026-07-06-perf-radical-o-notation.md` finding 3.2, rated
...
`docs/design/record-key-128-migration-plan.md`, and its 5-step
...
1. **Step 1 (safe, always do this)**: write a design doc at
   `docs/design/posting-list-sorted-slice-migration-plan.md` covering
...
[Investigation] Status: complete
  > Design doc written at docs/design/posting-list-sorted-slice-migration-plan.md
