...
> Реализуешь лист 0.5 плана `docs/roadmap/VECTOR_PRODUCTION_EXECUTION.md`.
...
- V0.4 (a603cacc) — vector_report (recall/RSS) + scripts/bench-vector.sh +
  docs/benchmarks/vector/README.md.

## Задача

### 1. Baseline-отчёт
Собрать baseline-отчёт качества/латентности и закоммитить в
`docs/benchmarks/vector/2026-07-05-baseline.md`.
...
- Отчёт по формату из `docs/benchmarks/vector/README.md` (reproducibility key:
...
- `docs/roadmap/EMBEDDINGS_AND_VECTORS.md` строка 3: статус «planned, no code
...
`docs/roadmap/VECTOR_PRODUCTION_PLAN.md` — исходный план разошёлся с кодом.
...
- `docs/benchmarks/vector/2026-07-05-baseline.md` — реальные recall/RSS числа
