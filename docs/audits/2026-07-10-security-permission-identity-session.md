...
_SCRAM/channel-binding не переаудитировался — см. `docs/audits/2026-07-06-security-network-surface.md` (handshake без пре-аутентификационного обхода; resume-тикет портативен между TLS-сессиями — finding 1d, решение #512 «no code change» по RFC 9266)._
