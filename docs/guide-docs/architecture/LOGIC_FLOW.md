...
- *Resumption tickets* are a system-within-a-system. The complexity is
  ...
  `docs/guide-docs/client-server-protocol-spec/SESSION_RESUMPTION.md` for the
  full mapping.
- *Transactions* — `BatchRequest.transactional: bool` exists on the
  ...
  `docs/dev-artifacts/roadmap/TRANSACTIONS.md`.
- *Embeddings & vector search* — not implemented yet; the design
  ...
  `docs/dev-artifacts/roadmap/EMBEDDINGS_AND_VECTORS.md`.
- *Full-text search* — not implemented yet; the design adds a new
  ...
  `docs/dev-artifacts/roadmap/FULL_TEXT_SEARCH.md`.
- *Constant-factor performance* (orthogonal to the above feature
  ...
  catalogue + sprint plan in `docs/dev-artifacts/roadmap/PERF_OPPORTUNITIES.md`.
