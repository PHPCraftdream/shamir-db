...
(`docs/audits/2026-07-06-security-compliance-supplychain.md`, LOW-MED) —
...
disclosure / supply-chain), [`../audits/shamir-storage.md`](../audits/shamir-storage.md)
(storage-layer audit), [`../perf/durability-model.md`](../perf/durability-model.md)
(WAL/durability model), [`../roadmap/TEMPORAL.md`](../roadmap/TEMPORAL.md) §3
(retention semantics).
...
(`docs/audits/2026-07-06-security-compliance-supplychain.md` §4 —
...
(`docs/roadmap/VALIDATORS.md`) are built around a small, stable set of
