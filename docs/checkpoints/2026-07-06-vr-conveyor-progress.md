...
`docs/audits/2026-07-06-*.md` — не закоммичены, зафиксированы для будущей
...
П-1/П-3/П-4) идёт последовательно**: бриф в `docs/prompts/vector/<NN>-*.md`
...
**НИЧЕГО не запушено.** Панельные audit-отчёты (`docs/audits/2026-07-06-*.md`,
...
- Открыт (отложен): что делать с находками панельного ревью
  (`docs/audits/2026-07-06-SUMMARY.md`) — 8 CRITICAL находок вне текущего
...
?? docs/checkpoints/*.md (untracked чекпоинты, включая этот)
```
```
...
`docs/prompts/vector/38-opti-dead-dotu8-norm-cache.md`._
