...
`docs/roadmap/VECTOR_PRODUCTION_EXECUTION.md`, запущенной через /babygoal
(цель «реализуй всю векторную кампанию»). Конвейер серийный по листам
(#393–#416): prompt-first бриф в `docs/prompts/vector/` (коммит ДО запуска) →
