...
- Ph0 (#186): ArtifactKind{Native,Wasm} into the schema-less QueryValue::Map catalogue
  ...
  docs/design/native-wasm-parity-phase0-findings.md.
...
- **The perf-hunt roadmap doc** (docs/checkpoints/2026-06-22-perf-hunt-roadmap.md) is still
...
encode_tests.rs, docs/design/native-wasm-parity-phase0-findings.md,
