...
Flat per-entry cost across a 20× depth range confirms O(W) scaling. Under the prior O(W²) regime, per-entry cost at W=20k would have been ~20× worse than at W=1k. BEFORE baseline not captured directly (sub-agent declined `git stash` in a shared workspace); architectural argument + flat-shape observation are the proof. Document at `docs/perf/op2-stage5-results.md`.
...
Docs (untracked, new):
- `docs/perf/op2-stage0-probes.md` — Stage 0 probe findings.
- `docs/perf/op2-stage5-results.md` — bench proof + verdict.
- `docs/perf/phase2-routing-decision-2026-06-21.md` — campaign routing (from prior turn).
- `docs/checkpoints/2026-06-21-2206.md` — earlier mid-Phase-1 checkpoint.
- `docs/checkpoints/2026-06-21-2320.md` — prior session-end checkpoint.
- `docs/checkpoints/op2-drainer-complete.md` — this file.
...
?? docs/checkpoints/2026-06-21-2320.md
?? docs/checkpoints/op2-drainer-complete.md
?? docs/perf/op2-stage0-probes.md
?? docs/perf/op2-stage5-results.md
