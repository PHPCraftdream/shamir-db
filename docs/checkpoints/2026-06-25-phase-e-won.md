...
поэтапный план follow-on** и записан в `docs/research/E4-FOLLOWON-PLAN.md`
...
- Прочий untracked: `docs/checkpoints/2026-06-24-2230.md` (старый чекпоинт).

## Repo state
```
?? .recovery-backup/
?? docs/checkpoints/2026-06-24-2230.md
?? docs/research/E4-FOLLOWON-PLAN.md
```
```
