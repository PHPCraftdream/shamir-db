...
> поддержка мульти-vector-index — в `docs/BACKLOG.md`.
...
селективности residual-предиката (см. `docs/design/vector-compaction.md`,
`docs/benchmarks/vector/2026-07-05-filtered-ann.md`):
...
Из `docs/benchmarks/vector/2026-07-05-quantization.md` (QUICK mode,
