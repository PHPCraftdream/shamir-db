...
use crate::db::query::batch::{QueryPath, QueryReference};

fn parse(
    s: &str,
) -> Result<QueryReference, crate::db::query::batch::reference::ReferenceParseError> {
...
fn test_parse_missing_at() {
    ...
    assert!(matches!(
        err,
        crate::db::query::batch::reference::ReferenceParseError::MissingAt
    ));
}
...
fn test_parse_empty_alias() {
    ...
    assert!(matches!(
        err,
        crate::db::query::batch::reference::ReferenceParseError::EmptyAlias
    ));
}
...
fn test_parse_invalid_alias() {
    ...
    assert!(matches!(
        err,
        crate::db::query::batch::reference::ReferenceParseError::InvalidAlias(_)
    ));
}
...
fn test_parse_unclosed_bracket() {
    ...
    assert!(matches!(
        err,
        crate::db::query::batch::reference::ReferenceParseError::UnclosedBracket
    ));
}
...
fn test_parse_invalid_index() {
    ...
    assert!(matches!(
        err,
        crate::db::query::batch::reference::ReferenceParseError::InvalidIndex(_)
    ));
}
...
fn test_parse_trailing_dot() {
    ...
    assert!(matches!(
        err,
        crate::db::query::batch::reference::ReferenceParseError::TrailingDot
    ));
}
